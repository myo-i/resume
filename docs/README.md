...
- **プロジェクトでの課題**
    ...
    しかしメンバー同士で協力しながら、トライアンドエラーを繰り返すことで理解を深め、問題を解決していくことができました。  
...
### 意欲・興味
- サービスなどに対してどういう機能が必要か、機能をどのように実装するかなど、サービスや事業に大きく関わるようなことをしたいです
- プログラムの実装や未経験の技術での開発など、試行錯誤を要する時が非常に楽しく、時間を忘れて没頭します
